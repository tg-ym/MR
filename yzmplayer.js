				...
				Y = function() {
					function e(t) {
						...
						a(this, e), this.options = (0, d.default)(t), this.options.video.quality && (this.qualityIndex = this.options.video
							...
							.add("yzmplayer-no-danmaku"), this.options.live && this.container.classList.add("yzmplayer-live"), (c.default.isMobile || this.container.offsetWidth <= 900) &&
							...
							this.container.innerHTML = (0, c.default)({
								...
								this.container.querySelector(".yzmplayer-controller"), this.commentInput = this.container.querySelector(
									...
									".yzmplayer-full-icon"), this.webFullButton = this.container.querySelector(".yzmplayer-full-in-icon"),
                                                                        this.popButton = this.container.querySelector(".yzmplayer-pop-icon"),
		...
		function(e, t, n) {
			...
			e.exports = function(e) {
				...
				return t +=
					...
					t += s(r("Normal")), t +=
					'</span>\n                    </div>\n                    <div class="yzmplayer-setting-speed-item" data-speed="1.25">\n                        <span class="yzmplayer-label">1.25</span>\n                    </div>\n                    <div class="yzmplayer-setting-speed-item" data-speed="1.5">\n                        <span class="yzmplayer-label">1.5</span>\n                    </div>\n                    <div class="yzmplayer-setting-speed-item" data-speed="2">\n                        <span class="yzmplayer-label">2</span>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class="yzmplayer-full">\n  <button class="yzmplayer-icon yzmplayer-pop-icon" data-balloon="',t += s(r("Video pop")), t +='" data-balloon-pos="up"><span class="yzmplayer-icon-content"><svg width="88" height="88" viewBox="0 0 88 88" xmlns="http://www.w3.org/2000/svg"><g fill="#FFF" fill-rule="evenodd"><path d="M68 16a8 8 0 018 8v24h-8V27.2a3.2 3.2 0 00-3.2-3.2H19.2a3.2 3.2 0 00-3.195 3.018L16 27.2v33.6a3.2 3.2 0 003.018 3.195L19.2 64H44v8H16a8 8 0 01-8-8V24a8 8 0 018-8h52z"></path><rect x="52" y="56" width="32" height="24" rx="4"></rect></g></svg></span>\n  </button>\n',t+='<button class="yzmplayer-icon yzmplayer-full-in-icon" data-balloon="',
				...
				p = function() {
					function e(t) {
						...
						a(this, e), this.player = t, this.autoHideTimer = 0, r.default.isMobile || (this.player.container.addEventListener(
								...
								n.setAutoHide()
							})), this.initPlayButton(), this.initThumbnails(), this.initPlayedBar(),this.initPopButton(), this.initFullButton(), this.initQualityButton(),
						...
						value: function() {
						 ...
						 value: function() {
                                                 ...
                                                 if(!document.pictureInPictureEnabled){
                                                       this.player.template.popButton.style.display="none";
                                                 }else{
                                                       this.player.template.popButton.addEventListener("click", function() {
                                                       try {
                                                                    if (e.player.video !== document.pictureInPictureElement) { 
